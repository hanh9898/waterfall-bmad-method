---
name: "hbc-setup"
description: Sets up HBLAB BMad Custom module in a project. Use when the user requests to 'install hbc module', 'configure HBLAB BMad Custom', or 'setup HBLAB BMad Custom'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/hbc/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code hbc
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code hbc --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
