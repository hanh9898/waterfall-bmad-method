...
HBC chạy **tuần tự, có cổng** qua 4 phase: mỗi phase hoàn thành (qua Phase Gate) rồi mới sang phase sau. Đây là *bộ xương* kiểu waterfall — nhưng áp dụng theo *từng tính năng* và có lõi TDD lặp ở Phase 3, nên không phải waterfall một-lần cứng nhắc (xem [HBC có thực sự là waterfall thuần?](why-incremental-tdd.md#hbc-có-thực-sự-là-waterfall-thuần-không)).
