...
> 🌐 **English** · [Tiếng Việt](../vi/index.md) · [⬅ Choose language](../index.md)
...
For those already running it who need to do a task.

- [Run a Phase Gate](how-to/run-a-phase-gate.md)
...
For when you need to look up a code/syntax.

- [Concept Glossary](reference/concept-glossary.md) — hit an unfamiliar term (deliverable, phase gate, traceability, TDD…)? look it up here.
- [Skills Catalog](reference/skills-catalog.md) — every agent & skill with run modes.
- [Deliverables Glossary](reference/deliverables-glossary.md) — every document HBC produces.
